 ...
 * @since 9.0
 */
@Test(testName = "marshaller.protostuff.EmbeddedRestMemcachedHotRodTest")
public class ProtostuffEmbeddedRestMemcachedHotRodTest extends AbstractInfinispanTest {
   ...
   protected void setup() throws Exception {
      cacheFactory = new CompatibilityCacheFactory<String, Object>(CACHE_NAME, new ProtostuffMarshaller(), CacheMode.LOCAL).setup();
   }
